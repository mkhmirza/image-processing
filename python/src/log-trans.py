...
def applyLogTransformation(img):
    # S = Clog(1+r), C (opacity) = 
    # creating a lambda function
    def logTransformation(i): return math.log2(1 + i)
...
if __name__ == "__main__":   
    ...
    improvedConstrast = applyLogTransformation(img)
